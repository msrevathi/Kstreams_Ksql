...
public class EventsProducer {
    ...
    private static ProducerRecord purchaseRecord(String key, String value) {
        return new ProducerRecord("user-purchase", key, value);
    }

    @SuppressWarnings("unchecked")
    static ProducerRecord userRecord(String key, String value) {
        return new ProducerRecord("user-event", key, value);
    }
}
